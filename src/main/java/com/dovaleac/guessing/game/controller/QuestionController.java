...
public class QuestionController {
  ...
  public HttpResponse<String> askForClue(
      @PathVariable int questionInGameId, @QueryValue int playerId, @QueryValue int currentClue) {
    questionService.askForClue(questionInGameId, playerId, currentClue);
    return HttpResponse.ok();
  }

  @Put("/{questionInGameId}/clue")
  public HttpResponse<String> giveClue(
      @PathVariable int questionInGameId, @QueryValue int nextClue) {
    questionService.giveClue(questionInGameId, nextClue);
    return HttpResponse.ok();
  }

  @Put("/{questionInGameId}/answer")
  public HttpResponse<String> guess(
      @PathVariable int questionInGameId,
      @QueryValue int playerId,
      @QueryValue int currentClue,
      @QueryValue String answer) {
  ...
  @Get("/{questionInGameId}/clues")
  public List<ClueRequest> getRequestedCluesForQuestion(@PathVariable int questionInGameId) {
    return questionService.getAllClueRequestsForQuestionInGame(questionInGameId);
  }
}
