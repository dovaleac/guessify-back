...
public class Game extends TableImpl<GameRecord> {
    ...
    private static final long serialVersionUID = 624751923;
    ...
    /**
     * The column <code>games.game.lang_id</code>.
     */
    public final TableField<GameRecord, Integer> LANG_ID = createField("lang_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<GameRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<GameRecord, ?>>asList(Keys.GAME__GAME_ROOM_ID_FKEY, Keys.GAME__GAME_GAME_CONFIG_ID_FKEY, Keys.GAME__GAME_LANG_ID_FKEY, Keys.GAME__GAME_QUESTION_SET_ID_FKEY, Keys.GAME__GAME_MASTER_PLAYER_ID_FKEY);
    }
    ...
    public Lang lang() {
        return new Lang(this, Keys.GAME__GAME_LANG_ID_FKEY);
    }
