...
public class AnswerRecord extends UpdatableRecordImpl<AnswerRecord> implements Record7<Integer, Integer, Integer, String, String, Integer, OffsetDateTime> {
    ...
    private static final long serialVersionUID = 246879688;
    ...
    /**
     * Setter for <code>games.answer.current_clue</code>.
     */
    ...
    /**
     * Getter for <code>games.answer.current_clue</code>.
     */
    ...
    public Field<Integer> field6() {
        return Answer.ANSWER.CURRENT_CLUE;
    }
     ...
     */
    public AnswerRecord(Integer id, Integer questionInGameId, Integer playerId, String answer, String status, Integer currentClue, OffsetDateTime moment) {
        super(Answer.ANSWER);
